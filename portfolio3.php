...
<div class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div id="mainMenu" class="collapse navbar-collapse">
        <ul class="nav navbar-nav">
          ...
          <li><a href="#Contact" data-toggle="modal" data-target='#modal'>Contacts</a></li>
          <li class='dropdown'>
...
<section id="home">
	<div class="jumbotron frosted">
		...
		<h2>We are group Cosmics</h2>
	</div>
	<div class="xy">
		<a type="button" class="btn btn-default" href="https://web.facebook.com/?_rdc=1&_rdr">Facebook</a>
		<a type="button" class="btn btn-default" href="https://web.facebook.com/?_rdc=1&_rdr">Blog</a>
		<a type="button" class="btn btn-default" href="https://github.com/lifya/lifyar">Github</a>
		<a type="button" class="btn btn-default" href="https://web.facebook.com/?_rdc=1&_rdr">FreeCodeCamp</a>
	</div>
</section>
...
<section id="About">
	<div class="jumbotron frosted">
		<div class="Id">
			<h2>Cosmics</h2>
			<p>Computer Science Informatics merupakan sebuah grup yang berisi 4 anggota, dimana anggota tersebut berencana membuat sebuah web mengenai sistem pakar pendeteksi penyakit jantung dengan menggunakan metode naive bayes</p>
		</div>
	</div>
</section>
